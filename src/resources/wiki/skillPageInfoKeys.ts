...
const resourceName = 'osrs_wiki_possible_skill_page_info_keys'
const fireUri = 'file://./fixtures/skillPageInfoKeys.json'
...
server.registerResource(
	...
	{
		name: resourceName,
		title: 'OSRS Wiki Skill Page Info Keys',
	...
	async () => {
		const filePath = join(process.cwd(), 'fixtures', 'skillPageInfoKeys.json');
